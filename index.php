        ...
        <div class="row align-content-between">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-center tittle01">Hi, Welcome to eShop</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" value="1" id="remember_me">
                                    <label class="form-check-label">Remember Me</label>
                                </div>
                            </div>

                            <div class="col-6">
                                <a href="#" class="link-primery" onclick="fogot_password();">Fogot Password</a>
                            </div>
            ...
            <div id="fogotPasswordModal" class="modal" tabindex="-1">
