        ...
        <div class="row">
            ...
            <div class="col-12 justify-content-center">
                <div class="row mb-3">
                    ...
                    <div class="col-8 col-lg-6">
                        <div class="input-group mt-3 mb-3">
                            ...
                            <select class="btn btn-outline-primary" id="basic_search_select">
                                <option value="0" readonlt>Select Catogery</option>
                                ...
                                for ($x = 0; $x < $n; $x++) {
                                    $fa = $rs->fetch_assoc();
                                ?>
                                    <option value="<?php echo $fa["id"]; ?>" readonlt><?php echo $fa["name"]; ?></option>
                                <?php
                                }
                    ...
                    <div class="col-2 d-grid gap-2">
                        <button class="btn btn-primary mt-3 search-button" onclick="basic_search(0);">Search</button>
                    </div>
            ...
            <div class="col-12" id="basicSearchResult">
                ...
                <div class="col-12 d-none d-lg-block">
                    <div class="row">
                        <div id="carouselExampleControls" class="carousel col-8 offset-2 slide " data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="resources/posterimg.jpg" class="d-block w-100 poster-img-1">
                                ...
                                <div class="carousel-item">
                                    <img src="resources/posterimg2.jpg" class="d-block w-100 poster-img-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="resources/posterimg3.jpg" class="d-block w-100 poster-img-1">
                                    <div class="carousel-caption d-none d-md-block poster-caption BeFree">
                ...
                ?>
                    ...
                    $resultset = Database::search("SELECT * FROM `product` WHERE `catogery` = '" . $cat["id"] . "' ORDER BY `date_time_added` DESC LIMIT 4 OFFSET 0");
                                        ...
                                        <div class="card col-6 col-lg-2 mt-1 mb-1" style="width: 18rem;">
                                            ...
                                            <div class="card-body ms-0 m-0">
                                                ...
                                                ?>
                                                    ...
                                                    <br />
                                                    <span class="card-text text-success"><b>No Items Available</b></span>
                                                ...
                                                if (isset($_SESSION["u"])) {
                                                    ...
                                                    ?>
                                                        ...
                                                        <a onclick='addToWatchlist(<?php echo $product["id"]; ?>);' class="btn btn-secondary col-12 mt-1"><i class="bi bi-heart-fill fs-5 text-danger"></i></a>
