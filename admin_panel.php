                        ...
                        <div class="align-items-start bg-dark col-12">
                            <div class="row g-2 text-center">
                                ...
                                <div class="col-12 mt-3 d-grid">
                                    ...
                                    <input type="date" class="form-control">
                                    <a href="#" class="btn btn-primary fw-bold mt-3">View Sellings</a>
                                    <hr class="border border-1 border-white">
                                    <hr class="border border-1 border-white">
                                </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-6 col-lg-4 px-1">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-12 bg-primary text-white text-center rounded" style="height: 100px;">
                                            ...
                                            $invoice_nr = $invoice_rs->num_rows;


                                            for ($x = 0; $x < $invoice_nr; $x++) {
                                ...
                                <div class="col-6 col-lg-4 px-1">
                                    <div class="row g-1">
                                        ...
                                        <div class="col-12 bg-danger text-white text-center rounded" style="height: 100px;">
                                            ...
                                            $user_nr = $user_rs->num_rows;

                                            ?>
                                            <span class="fs-5"><?php echo $user_nr; ?> Requests</span>
                                        </div>
                        ...
                        <div class="col-12 bg-dark">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-9 text-end mt-3 mb-3">
                                    <label class="form-label fs-4 fw-bold text-white"><?php echo $difference->format('%Y') . " Years " . $difference->format('%m') . " Month " . $difference->format('%d') . " Days "
                                                                                            . $difference->format('%H') . " Hours " . $difference->format('%i') . " Minutes " . $difference->format('%s') . " Seconds"; ?></label>
                                </div>
                        ...
                        <div class="offset-1 col-10 col-lg-4 mt-3 mb-3 rounded bg-light">
                            <div class="row g-1">
                                ...
                                <div class="col-12">
                                    <img src="resources/user.svg" class="img-fluid rounded-top" style="height: 250px;">
                                    <hr>
                                </div>

                                <div class="col-12 text-center">
                                    <span class="fs-5 fw-bold">Achira Dimuthu</span><br>
                                    <span class="fs-6">achira@gmail.com</span><br>
                                    <span class="fs-6">0711219636</span>
                                </div>
