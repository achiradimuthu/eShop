        ...
        <div class="row">
            ...
            <div class="col-12" id="page">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-12 text-end fw-bold">
                                ...
                                <span>+9471 1219636</span><br>
                                <span>achira@gmail.com</span>
                            </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <h2>Achira Dimuthu</h2>
                                <span>Bulugahapitiya</span><br>
                                <span>Eheliyagoda</span><br>
                                <span>achira@gmail.com</span>
                            </div>
                            ...
                            <div class="col-6 text-end mt-4">
                                ...
                                <span class="fw-bold">2022-04-10 08:30:00</span>
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr style="height: 72px;">
                                    ...
                                    <td>
                                        <span class="fw-bold p-2 text-primary text-decoration-underline">0000001</span><br>
                                        <span class="fw-bold p-2 fs-3 text-primary">Apple iPhone X</span>
                                    </td>
                                    <td class="fs-6 text-end pt-3 bg bg-secondary text-white">Rs. 100000 .00</td>
                                    <td class="fs-6 text-end pt-3">01</td>
                                    <td class="fs-6 text-end bg bg-primary text-white">Rs. 100000 .00</td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="fs-5 text-end border-primary text-primary fw-bold">Rs. 100000 .00</td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="col-12 mt-3 mb-3 border border-5 border-primary border-start border-top-0 border-bottom-0 border-end-0 rounded" style="background-color: #e7f2ff;">
                        <div class="row">
                            <div class="col-12 mt-3 mb-3">
                                <label class="form-label fs-5 fw-bold">NOTICE : </label><br>
                                <label class="form-label fs-6">Purchesed items can return before 7 days of Delivery.</label>
                            </div>
                        </div>
                    </div>
