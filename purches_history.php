                ...
                <div class="row">
                    ...
                    <div class="col-12 d-none d-lg-block">
                        <div class="row">
                            ...
                            <div class="col-2 bg-light text-end">
                                <label class="form-label fw-bold">Purches Date & Time</label>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text"><b>Seller : </b>Achira Dimuthu</p>
                                    ...
                                    <div class="col-12 col-lg-2 text-center text-lg-end bg-light">
                                        <label class="form-label fs-5 px-3 py-5 fw-bold">2022-06-01 08:35:16</label>
                                    </div>
                                    <div class="col-12 col-lg-3">
                                        <div class="row">
